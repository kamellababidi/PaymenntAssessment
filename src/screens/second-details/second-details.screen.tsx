...
type Props = NativeStackScreenProps<IApplicationStackParamList, 'SecondDetails'>;

export const SecondDetailsScreen = ({ route }: Props) => {
  return (
    <View style={[GLOBAL_STYLE.center, GLOBAL_STYLE.fill]}>
      <Text style={styles.text}>Details Screen 2 with [{route?.params?.objectId}]</Text>
    </View>
  );
  // ------------------------------------------------------------------------------------------
